...
export function SendSMSModal({ 
  ...
  const [message, setMessage] = useState(`Hi ${recipientName}, I wanted to reach out regarding your account. Please let me know if you have any questions.`)
              ...
              <div className="flex-1 overflow-y-auto px-6 py-4">
                <div className="space-y-4">
                  <div>
                    ...
                    <p className="text-base font-medium">{recipientName} ({recipientPhone})</p>
                  </div>
